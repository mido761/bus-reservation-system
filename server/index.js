...
app.use(
  session({
    ...
    store: MonogoStore.create({
      mongoUrl:
        "mongodb+srv://midotareq2:bmNS1j6FLban6kZv@cluster0.ntwma.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    }),
    cookie: {
      httpOnly: true,
...
app.post("/payment", async (req, res) => {
  ...
  const updateduser = await userModel.findByIdAndUpdate(userId, { $push: { bookedBuses: busId } }, { new: true })
})
