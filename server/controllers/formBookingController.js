...
const bookSpot = async (req, res) => {
  ...
  try {
    ...
    const numberOfSeats = await Seat.countDocuments({ bookedBy: userId, busId: busId }); // count the number of seats for the user
...
// cancel seat
const cancelSpot = async (req, res) => {
  const busId = req.params.busId;
...
module.exports = {getFormDetails, bookSpot, cancelSpot} 