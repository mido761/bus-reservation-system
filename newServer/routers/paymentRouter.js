...
import { getUserPayments, getPaymentByBooking, addPayment, webhook, editPayment, refundPayment, standAlonePayment,vodafoneCash,getPaymentByTrx,confirmPayment,rejectPayment} from "../controllers/paymentController.js";
...
// router.post('/reject-VF-payment',rejectPayment);
